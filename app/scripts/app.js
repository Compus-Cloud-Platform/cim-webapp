  ...
  [          '$stateProvider', '$urlRouterProvider',
    function ($stateProvider, $urlRouterProvider) {
      ...
      $stateProvider
        ...
        .state('teacher.course-add', {url: '/course-add', templateUrl: 'views/teacher/course.add.html'})
        .state('teacher.course-group', {url: '/course-group/:teacherCourseId', templateUrl: 'views/teacher/course.group.html'})
        ...
        .state('super-admin.org-map-major', {url: '/org-map-major/:orgDeptId', templateUrl: 'views/super-admin/org-map-major.html'})
